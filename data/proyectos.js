...
export const proyectosData = [
  {
    ...
    description: "Una plataforma de chat avanzada que integra múltiples modelos de IA (GPT-4, Claude, DeepSeek) con análisis semántico, memoria contextual y personalización adaptativa.",
    longDescription: `
    ...
    technologies: ["React", "Node.js", "Python", "FastAPI", "LangChain", "Pinecone", "OpenAI", "Claude", "DeepSeek", "TailwindCSS", "Framer Motion"],
  ...
  },
  {
    ...
    description: "Un framework completo de seguridad que implementa principios éticos hacker para proteger aplicaciones web, incluyendo detección de vulnerabilidades y hardening automático.",
    longDescription: `
    ...
    technologies: ["Python", "FastAPI", "Redis", "PostgreSQL", "Docker", "Nginx", "OpenSSL", "JWT", "OAuth2", "Prometheus"],
    ...
    tags: ["seguridad", "ethical-hacking", "framework", "vulnerabilidades", "protección"]
  },
  {
    id: 3,
    title: "MindfulCode",
    subtitle: "Editor de Código con Principios de Programación Consciente",
    description: "Un editor de código único que integra técnicas de mindfulness y bienestar digital para crear una experiencia de programación más consciente y productiva.",
    longDescription: `
    ...
    technologies: ["Electron", "TypeScript", "Monaco Editor", "React", "Node.js", "SQLite", "Chart.js", "Howler.js"],
  ...
  },
  {
    ...
    description: "Mi portafolio personal construido con Next.js, featuring animaciones cuánticas, diseño neuromórfico y una experiencia inmersiva que refleja mi filosofía de programación consciente.",
    longDescription: `
    ...
    technologies: ["Next.js", "React", "TailwindCSS", "Framer Motion", "TypeScript", "Vercel"],
  ...
  },
  {
    ...
    description: "Una aplicación que combina inteligencia artificial con prácticas espirituales, generando meditaciones personalizadas basadas en el estado emocional y objetivos del usuario.",
    longDescription: `
    ...
    technologies: ["React Native", "Python", "TensorFlow", "Firebase", "Spotify API", "WebGL", "Three.js"],
